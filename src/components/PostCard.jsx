    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <p style={{ margin: 0, fontSize: '13px', fontWeight: 600, color: 'white', lineHeight: 1.2 }}>
            {userName}
          </p>
      ...
      <div style={{ position: 'relative', width: '100%', aspectRatio: '4/3', background: '#080E1A', overflow: 'hidden' }}>
        {isVideo && hasMedia ? (
          <video
            src={mediaSrc} controls playsInline muted
            style={{ width: '100%', height: '100%', objectFit: 'cover' }}
          />
        ) : (
          <img
            src={mediaSrc} alt={post.title} loading="lazy"
            style={{ width: '100%', height: '100%', objectFit: 'cover' }}
          />
        )}
